var syntax         = 'scss', // Syntax: sass or scss;
		...
		gmWatch        = false; // ON/OFF GraphicsMagick watching "img/_src" folder (true/false). Linux install gm: sudo apt
// update; sudo apt install graphicsmagick
...
if (gulpVersion == 3) {
	...
	gulp.task('watch', taskArr, function() {
		...
		gmWatch && gulp.watch('app/img/src/**/*', ['img']);
	});
